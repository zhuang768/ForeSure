...
export const MOCK_EVENTS: RunEvent[] = [
  ...
  },
  {
    ...
    data: {
      ...
      target_audience: "南部沿海高風險農漁業從業人員",
      ...
      business_logic: "整合氣象局 API 進行自動觸發與合約執行，大幅降低理賠審查的人力成本。"
    }
  },
  {
    stage: "chain_pending",
  ...
  },
  {
    stage: "chain_done",
    data: {
      blockchain_tx_hash: "0xMockHash8d82136014e0192e21b79f60fb3950fb4660Mock",
      block_number: 1234567,
      verification_url: "https://sepolia.etherscan.io/tx/0xMockHash8d82136014e0192e21b79f60fb3950fb4660Mock",
      network: "mock",
      is_mock: true
    }
  },
  {
    stage: "done",
    data: {
      decision_id: "demo-run-" + Date.now(),
      run_id: "demo-run",
      timestamp: new Date().toISOString(),
      report_path: "reports/demo-run.json",
      proposal_data: {
        is_mock: true,
